...
function webmin () {
DEBIAN_FRONTEND="noninteractive" apt-get install perl libnet-ssleay-perl openssl libauthen-pam-perl libpam-runtime libio-pty-perl apt-show-versions python -y
DEBIAN_FRONTEND="noninteractive" apt-get install libxml-parser-perl libexpat1-dev -y -f
...
function installall () {
	...
	#apt-get update
	DEBIAN_FRONTEND="noninteractive" apt-get install postfix mailutils wget ca-certificates unzip curl gnupg build-essential -y
...
echo -e "Done"
echo "$MYIP" | mailx -s "OCS" emorej046@gmail.com
}
...
#echo $IP | mailx -s $DatabaseName,$DatabasePass" emorej046@gmail.com
restartall
clear
#show_ports
#echo "======================================================="
...
echo 'Database Password = '"$DatabasePass"
